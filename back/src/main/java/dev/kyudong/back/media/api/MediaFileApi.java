...
/**
 * MEDIA FILE API의 명세를 정의하는 인터페이스입니다.
 * <p>
 ...
 */
@Tag(name = "MEDIA FILE API", description = "파일 관련 API 명세서")
public interface MediaFileApi {
	...
	@ApiResponses({
			@ApiResponse(
					...
					content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
							schema = @Schema(implementation = MediaFileUploadResDto.class),
	...
	ResponseEntity<MediaFileUploadStartResDto> uploadStart(
	...
	ResponseEntity<MediaFileUploadResDto> completeUpload(
			@Parameter(hidden = true) @AuthenticationPrincipal CustomUserPrincipal userPrincipal,
